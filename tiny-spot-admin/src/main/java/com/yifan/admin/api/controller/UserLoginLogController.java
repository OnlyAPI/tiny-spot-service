...
public class UserLoginLogController {
    ...
    @ApiOperation("分页获取用户登录日志")
    @Right(rightsOr = "monitor:loginlog:list")
    @RequestMapping(value = "/list", method = RequestMethod.GET)
    public BaseResult<CommonPage<UserLoginLog>> list(MonitorLoginLogParam param) {
        Page<UserLoginLog> adminList = userLoginLogService.list(param);
